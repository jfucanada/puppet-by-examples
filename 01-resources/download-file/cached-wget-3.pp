    exec { 'cached-wget':
        ...
        command => 'wget -N -P /var/cache/wget ftp://ftp.ruby-lang.org/pub/ruby/2.2/ruby-2.2.0.tar.gz',
        onlyif  => 'test ! -f /var/cache/wget/ruby-2.2.0.tar.gz',
    }

# tar zxf ruby-2.2.0.tar.gz -C /tmp/ruby-2.2.0
